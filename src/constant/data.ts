...
export const DATA: TypingData = {
	easy: [
		...
		{
			id: "easy-7",
			text: "The cat sat on the window sill, watching the rain drops fall down the glass one by one. She seemed happy to be inside where it was dry and warm.",
		},
		{
			id: "easy-8",
